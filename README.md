...
-	Modeled analytics datasets to support KPI tracking, trend analysis, and benchmarking across business units.
-	Developed Tableau dashboards backed by curated analytics tables, improving performance, reliability, and usability for stakeholders.
-	Managed data imports and exports across systems using Excel and Tableau to support reporting and operational tracking.
-	Identified and resolved data discrepancies by reviewing source documents and collaborating with stakeholders.
...
-	Built standardized tables and reports to support stakeholder analysis and operational decision-making.
-	Conducted data quality audits to identify missing values, inconsistencies, and logic gaps.
...
-	Built interactive dashboards and automated reporting workflows, reducing manual analysis time and improving research reproducibility.
...
- Developed interactive KPI dashboards tracking readmissions, occupancy, and length of stay (LOS), reducing manual reporting time by 30% and improving visibility for leadership.
...
-	Applied CMS HACRP scoring to compute facility-level penalty risk, standardized infection ratios, and “penalty countdown” metrics for FY2026-2028.
-	Designed interactive Tableau dashboards to visualize allowable and excess HAI events, supporting data-driven facility risk management and state-level planning.

**2. High-Performance Computing for Analyzing Motor Vehicle Collision Trends (HDS 5230) | 01/2024 - 04/2025**
-	Analyzed over 1.7M NYC collision records using Dask parallelization, reducing processing time by 62%.
-	Built Random Forest models (99.93% accuracy) to predict injury likelihood, identifying high-risk zones and contributing factors.
-	Delivered actionable insights for public safety planning and resource allocation.
...
**4. Diagnosis-Related Groups (DRGs) and Hospital Coverage Analysis**
...
**5. Exploratory Data Analysis (EDA) of Gastric Cancer Biomarkers**
...
-	CITI Biomedical Research Investigators & Key Personnel - CITI Program (2024, Valid until 2027)
